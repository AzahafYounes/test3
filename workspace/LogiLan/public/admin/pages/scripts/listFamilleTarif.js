var TableEditable = function () {
    ...
    var handleTable = function () {
        ...
        var oTable = table.dataTable({
            ...
            "lengthMenu": [
                [-1, 5, 15, 20],
                ["TOUS", 5, 15, 20] // change per page values here
            ],
		...
		table.find('.group-checkable').change(function () {
         ...
         table.on('click', 'td a.delete', function (e) {
            ...
            if (confirm("Etes-vous sur de vouloir supprimer cette famille tarifaire ?") == false) {
                return;
				} 
            ...
            var id = $(this).attr('rel');
				...
				$.ajax({
        	        ...
        	        success : function(response) {
						...
						$("#marge1").val(response.marge);
						$("#tva1").val(response.tva);
						$("#update").val(response.idFamilleT);
						$('#large1').modal("show");

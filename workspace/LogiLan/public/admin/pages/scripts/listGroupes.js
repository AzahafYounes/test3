var TableEditable = function () {
    ...
    var handleTable = function () {
        ...
        var oTable = table.dataTable({
            ...
            "lengthMenu": [
                [-1, 5, 10, 20],
                ["TOUS", 5, 10, 20] // change per page values here
            ],
            "pageLength": 10,
		...
		table.find('.group-checkable').change(function () {
         ...
         table.on('click', 'td a.delete', function (e) {
            ...
            if (confirm("Etes-vous sur de vouloir supprimer ce groupe ?") == false) {
                return;
				} 
				...
				$.ajax({
        	        ...
        	        success : function(response) {
						...
						if(response.manager==1){
							...
							$("#manager1").prop('checked', true); 
						}else{
							$("#manager1").prop('checked', false);
						}
						$("#user1").val(response.user.id);

    ...
    var handleTable = function () {
		...
		table.find('.group-checkable').change(function () {
         ...
         table.on('click', 'td a.delete', function (e) {
            ...
            if (confirm("Etes-vous sur de vouloir supprimer cet officine ?") == false) {
                return;
				} 

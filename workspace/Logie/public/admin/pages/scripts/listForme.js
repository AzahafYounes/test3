var TableEditable = function () {
    ...
    var handleTable = function () {
        ...
        var oTable = table.dataTable({
            ...
            "lengthMenu": [
                [-1, 5,10, 15, 20],
                ["TOUS", 5,10, 15, 20] // change per page values here
            ],
		...
		table.find('.group-checkable').change(function () {
         ...
         table.on('click', 'td a.delete', function (e) {
            ...
            if (confirm("Etes-vous sur de vouloir supprimer cette forme ?") == false) {
                return;
				} 
            ...
            var id = $(this).attr('rel');
				...
				$.ajax({
        	        ...
        	        success : function(response) {
						...
						$("#foDesig1").val(response.foDesig);
						$("#update").val(response.idForme);
						$('#large1').modal("show");

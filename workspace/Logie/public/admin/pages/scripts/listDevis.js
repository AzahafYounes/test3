var TableEditable = function () {
    ...
    var handleTable = function () {
		...
		function editRow(oTable, nRow) {
            ...
            jqTds[1].innerHTML = '<input id="code" class="form-control input" value='+aData[1]+' disabled>';
            jqTds[2].innerHTML = '<input id="intitule" type="text" class="form-control input" value="' + aData[2] + '">';
            jqTds[3].innerHTML = '<textarea id="descirpt" class="form-control input" style="overflow:auto;resize:none">' + aData[3] + '</textarea>';
            jqTds[4].innerHTML = '<a class="edit" href="" rel="saveEdit"><img src="../../assets/img/edit.png"/></a> &nbsp; <a class="delete" href="" rel="'+id+'"><img src="../../assets/img/delete.png"/></a>';
		...
		function addRow(oTable, nRow) {
			...
			jqTds[1].innerHTML = '<input id="code" type="text" class="form-control input" value="' + aData[1] + '">';
            jqTds[2].innerHTML = '<input id="intitule" type="text" class="form-control input" value="' + aData[2] + '">';
            jqTds[3].innerHTML = '<textarea id="descirpt" class="form-control" style="overflow:auto;resize:none">' + aData[3] + '</textarea>';
            jqTds[4].innerHTML = '<a class="save" href="" rel="save"><img src="../../assets/img/save.png"/></a> &nbsp; <a class="cancel" href=""><img src="../../assets/img/cancel.png"/></a>';
		...
		function saveRow(oTable, nRow) {
        	    ...
        	    $.ajax({
        	        ...
        	        success : function(response) {
        	            ...
        	            oTable.fnUpdate(intitule, nRow, 2, false);
        	            oTable.fnUpdate(description, nRow, 3, false);
        	            oTable.fnUpdate('<a class="edit" href=""><img src="../../assets/img/edit.png"/></a> &nbsp;&nbsp; <a class="delete" href="" rel="'+ response.id +'"><img src="../../assets/img/delete.png"/></a>', nRow, 4, false);
        	            oTable.fnDraw();
        	        },
        	        error : function(request, status, error) {
						$("#ajax").modal("hide");
        	        	$("#msg1").html("Erreur, code existant ou non saisi");
						$("#large").modal("show");
						setTimeout(function() {$("#large").modal("hide");}, 2000);
						}
		...
		function updateRow(oTable, nRow) {
        	    ...
        	    $.ajax({
        	        ...
        	        success : function(response) {
        	            ...
        	            oTable.fnUpdate(intitule, nRow, 2, false);
        	            oTable.fnUpdate(description, nRow, 3, false);
        	            oTable.fnUpdate('<a class="edit" href=""><img src="../../assets/img/edit.png"/></a> &nbsp;&nbsp; <a class="delete" href="" rel="'+ code +'"><img src="../../assets/img/delete.png"/></a>', nRow, 4, false);
        	            oTable.fnDraw();
        	        },
        	        error : function(request, status, error) {
						console.log(error);
